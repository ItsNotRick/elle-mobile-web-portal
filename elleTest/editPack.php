   ...
   if(isset($_SESSION['langPack'])){
	...
	if ($rows){
		while ($row = mysqli_fetch_array($result)){
			...
			echo '  ' .$row['definition'] . ''; 
			echo '</td><td>';
			echo '<button type="submit" name="edit" value="' .$row['id'] . '" style="width:auto; background-color:orange">Edit</button>';
                        echo '</td><td>';
                        echo '<button type="submit" name="delete" value="' .$row['id'] . '" style="width:auto; background-color:red">Delete</button>';
			echo '</td></tr>';
